...
* [Refactorings Catalog](http://refactoring.com/catalog/) - A catalog of refactorings for OO languages. Each refactoring includes the problem, solution and some sketches for common situations.
